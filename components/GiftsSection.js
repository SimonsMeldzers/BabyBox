  ...
  return (
    <div className='gifts-container'>
        ...
        <div className='gifts-divs'>
            ...
            <Link href='/' className='gifts-img-text'><Typography variant='h6' > Dāvanas zem 25.00€ {arrowSVG}</Typography> </Link>
        </div>

        <div className='gifts-divs'>
            <Link href='/'><img  src="https://i.ibb.co/5M6pW14/baby-gift-box-480x480.webp" className='gifts-img'/></Link>
            <Link href='/' className='gifts-img-text'><Typography variant='h6' > Dāvanas zem 35.00€ {arrowSVG}</Typography> </Link>
        </div>
        ...
        <div className='gifts-divs'>
            <Link href='/'><img  src="https://i.ibb.co/WBF4gb3/il-fullxfull-4182593184-iman.webp" className='gifts-img'/></Link>
            <Link href='/' className='gifts-img-text'><Typography variant='h6' > Visas Dāvanas {arrowSVG}</Typography> </Link>
        </div>
